...
struct HomeView: View {
    ...
    var body: some View {
        ...
        #if DEBUG
        // Debug-only: `-autoCanvas 1` skips the home screen and shows
        // the canvas immediately. Used for screenshot / motion-language
        // verification, not part of the V0.1 user flow.
        .onAppear {
